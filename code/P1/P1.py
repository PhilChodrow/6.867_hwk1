...
if __name__ == '__main__':
    ...
    # # Gaussian - Function surface + path - Gaussian
    ...
    # # Quadratic Bowl - Function surface + path
    ...
    #
    # # Quadratic Bowl - convergence of the gradient
    ...
    #
    # # # Quadratic Bowl,Gaussian - convergence of the gradient
    # # xes = range(0, len(GradNormBowl))
    # # plt.figure(figsize=(15, 10))
    # # plt.subplot(211)
    # # plt.plot(range(0, len(GradNormBowl)), GradNormBowl)
    # # plt.plot(range(0, len(GradNormGauss)), GradNormGauss)
    # # # plt.legend([Bowl, Gaussian])
    # # plt.xlabel('Iteration')
    # # plt.ylabel('Second Norm of the Gradient')
    # # plt.title('Gradient Norm Convergence rate - Quadratic Bowl vs. Gaussian')
    # # #plt.show()
    #
    # # print "Convergence for Different Starting Points - Quadratic Bowl"
    # ConvergenceRate = np.zeros((10, 10))
    # for x in range(0, 10):
    #     for y in range(0, 10):
    ...
    #
    #
    # # Quadratic Bowl - convergence - step size
    # # ConvergenceRate = []
    ...
    # # plt.show()
    #
    # # Quadratic Bowl - convergence - error
    # # ConvergenceRate = []
    # Errors = range(-25, -1)
    # # StepSize = 0.1
    # # for Error in Errors:
