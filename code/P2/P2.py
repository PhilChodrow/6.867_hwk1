...
if __name__ == '__main__':
    ...
    print "Batch: running time is ", BatchElapsedTime, "Num of iterations is ", NumberOfIterBatch, \
        "Final optimum is ", BatchOpt
    print "SGD: running time is ", SGDElapsedTime, "Num of iterations is ", NumberOfIterSGD, \
        "Final optimum is ", SGDOpt
